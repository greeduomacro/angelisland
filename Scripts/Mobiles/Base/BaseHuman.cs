...
namespace Server.Mobiles
{
	public class BaseHuman : BaseCreature
	{
        ...
        public BaseHuman(AIType ai,FightMode mode,int iRangePerception,int iRangeFight,double dActiveSpeed,double dPassiveSpeed) : base(ai,mode,iRangePerception,iRangeFight,dActiveSpeed,dPassiveSpeed)
		{
            InitTriggers();
		}

		public BaseHuman( Serial serial ) : base( serial )
		{
            InitTriggers();
		}
