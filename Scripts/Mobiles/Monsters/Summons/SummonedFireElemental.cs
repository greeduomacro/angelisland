...
/* Scripts/Mobiles/Monsters/Summons/SummonedFireElemental.cs
 * ChangeLog
 *  8/16/06, Rhiannon
...
namespace Server.Mobiles
{
	...
	public class SummonedFireElemental : BaseCreature
	{
		...
		[Constructable]
		public SummonedFireElemental () : base( AIType.AI_Mage, FightMode.All | FightMode.Closest, 10, 1, 0.25, 0.5 )
		{
