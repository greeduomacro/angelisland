...
/*
		...
		{
			ArrayList rights = BaseCreature.GetLootingRights( creature.DamageEntries );
		...
		[Constructable]
		public DemonKnight() : base( AIType.AI_Mage, FightMode.All | FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
