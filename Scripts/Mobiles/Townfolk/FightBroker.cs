...
namespace Server.Mobiles
{
	...
	{
		private const int REGISTRATION_FEE = 100;
		private const int REGISTRATION_ADDITION = 10; //this is charged per registrant already registered
		private const int WHERE_FEE = 100;
		...
		[Constructable]
		public FightBroker() : base( "the fight broker" )
		{
			IsInvulnerable = true;
		}
		...
		public static void Initialize()
		{
			...
			Server.Commands.Register( "fightbroker", AccessLevel.GameMaster, new CommandEventHandler( FightBroker_OnCommand ) );
		}
