...
namespace Server.Mobiles
{
	...
	public class AdamsCat : BaseChampion
	{
		...
		[Constructable]
		public AdamsCat() : base( AIType.AI_Melee, FightMode.Aggressor, 0.2, 0.4 )
		{
			// non-champ AI
			RangePerception = 10;
			RangeFight = 1;
		...
		public AdamsCat( Serial serial ) : base( serial )
		{
		}
	...
	public class BallOfYarn : Item
	{
		...
		[Constructable]
		public BallOfYarn( TimeSpan delay, TimeSpan paraTime ) : base( 0x10d4 )
		{
			m_ParaTime = paraTime;
		...
		public BallOfYarn( Serial serial ) : base( serial )
		{
		}
