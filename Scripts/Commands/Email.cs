...
namespace Server.Scripts.Commands
{
	...
	public class AddressDump
	{
		public static void Initialize()
		{
			Server.Commands.Register("AddressDump", AccessLevel.Administrator, new CommandEventHandler(AddressDump_OnCommand));
		}
	...
	public class Announcement
	{
		public static void Initialize()
		{
			Server.Commands.Register("Announcement", AccessLevel.Administrator, new CommandEventHandler(Announcement_OnCommand));
		}
