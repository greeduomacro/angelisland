...
{ 
	...
	{ 
		...
		{ 
			Commands.Register( "InternalMobiles", AccessLevel.Administrator, new CommandEventHandler( InternalMobiles_OnCommand ) ); 
		} 
		...
		public InternalMobilesGump( Mobile owner, ArrayList list, int page ) : base( GumpOffsetX, GumpOffsetY ) 
		{ 
