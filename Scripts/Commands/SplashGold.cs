...
namespace Server.Scripts.Commands
{
	public class SplashGold
	{
		...
		private class SplashTarget : Target
		{
			...
			public SplashTarget( int amount ) : base( 15, true, TargetFlags.None )
			{
				m_Amount = amount;
			}	
		...
		private class GoodiesTimer : Timer
		{
			...
			public GoodiesTimer( Map map, int x, int y, int amount ) : base( TimeSpan.FromSeconds( Utility.RandomDouble() * 10.0 ) )
			{
				m_Amount = amount;
				m_Map = map;
				m_X = x;
