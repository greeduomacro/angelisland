...
namespace Server.Scripts.Commands
{
	...
	public class InterfaceGump : BaseGridGump
	{
		...
		public InterfaceGump( Mobile from, ArrayList list, int page ) : base( 30, 30 )
		{
			m_From = from;
			m_List = list;
			m_Page = page;
	...
	public class InterfaceItemGump : BaseGridGump
	{
		...
		public InterfaceItemGump( Mobile from, ArrayList list, int page, Item item ) : base( 30, 30 )
		{
			m_From = from;
			m_List = list;
			m_Page = page;
	...
	public class InterfaceMobileGump : BaseGridGump
	{
		...
		public InterfaceMobileGump( Mobile from, ArrayList list, int page, Mobile mob ) : base( 30, 30 )
		{
			m_From = from;
			m_List = list;
			m_Page = page;
