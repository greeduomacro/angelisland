...
namespace Server.Tools
{
	...
	public class VendorTool : Item
	{
		...
		public VendorTool(Serial serial) : base (serial)
		{
		}
	...
	{
		public VendorToolTarget() : base(8, false, TargetFlags.None)
		{
		}
	...
	class VendorToolGump : Gump
	{
		...
		public VendorToolGump(Mobile from, PlayerVendor pv) : this(from, pv, 0)
		{
		}

		public VendorToolGump(Mobile from, PlayerVendor pv, int page) : base(50, 40)
		{
