...
namespace Server.Misc
{
	public class AutoRestart : Timer
	{
		...
		{
            Commands.Register("ServerWars", AccessLevel.GameMaster, new CommandEventHandler(ServerWars_OnCommand));
            Commands.Register( "Restart", AccessLevel.Administrator, new CommandEventHandler(Restart_OnCommand) );
			Commands.Register( "RestartTime", AccessLevel.Administrator, new CommandEventHandler( RestartTime_OnCommand ) );
