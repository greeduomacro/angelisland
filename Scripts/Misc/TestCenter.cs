...
namespace Server.Misc
{
	public class TestCenter
	{
		...
		public static void Configure()
		{
			...
			{
				Console.WriteLine("[TEST CENTER functionality enabled.]");
				m_Enabled = true;
			}
			else
				m_Enabled = false;
		...
		public class TCSetSkills
		{
			...
			{
                if (!args.Handled && Insensitive.StartsWith(args.Speech, "petset"))
                {
				...
				if ( !args.Handled && Insensitive.StartsWith( args.Speech, "set" ) )
				{
