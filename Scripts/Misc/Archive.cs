...
{
	public class Archive : FakeContainer
	{
		// archiver commands
		public static void Initialize()
		{
			Server.Commands.Register("AddToArchive", AccessLevel.Administrator, new CommandEventHandler(OnAddToArchive));
			Server.Commands.Register("RestoreFromArchive", AccessLevel.Administrator, new CommandEventHandler(OnRestoreFromArchive));
			Server.Commands.Register("ReturnToArchive", AccessLevel.Administrator, new CommandEventHandler(OnReturnToArchive));
			Server.Commands.Register("RemoveFromArchive", AccessLevel.Administrator, new CommandEventHandler(OnRemoveFromArchive));
			Server.Commands.Register("DumpArchive", AccessLevel.Administrator, new CommandEventHandler(OnDumpArchive));
		}
