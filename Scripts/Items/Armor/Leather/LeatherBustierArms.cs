...
namespace Server.Items
{
	...
	public class CorpseSkinBustier : BaseArmor
	{
		...
		[Constructable]
		public CorpseSkinBustier() : base( 0x1C0A )
		{
			Weight = 1.0;
			Hue = 2101;
		...
		public CorpseSkinBustier( Serial serial ) : base( serial )
		{
		}
		...
		public class HellishBustier : BaseArmor
	{
		...
		[Constructable]
		public HellishBustier() : base( 0x1C0A )
		{
			Weight = 1.0;
			Hue = 1645;
			ProtectionLevel = ArmorProtectionLevel.Guarding;
		...
		public HellishBustier( Serial serial ) : base( serial )
		{
		}
