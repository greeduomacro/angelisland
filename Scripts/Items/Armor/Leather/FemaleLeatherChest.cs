...
namespace Server.Items
{
	...
	public class CorpseSkinArmor : BaseArmor
	{
		...
		[Constructable]
		public CorpseSkinArmor() : base( 0x1C06 )
		{
			Weight = 1.0;
			Hue = 2101;
		...
		public CorpseSkinArmor( Serial serial ) : base( serial )
		{
		}
		...
		public class HellishArmor : BaseArmor
	{
		...
		[Constructable]
		public HellishArmor() : base( 0x1C06 )
		{
			Weight = 1.0;
			Hue = 1645;
			ProtectionLevel = ArmorProtectionLevel.Guarding;
		...
		public HellishArmor( Serial serial ) : base( serial )
		{
		}
