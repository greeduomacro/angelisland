...
namespace Server.Items
{
	...
	public class CorpseSkinShorts : BaseArmor
	{
		...
		[Constructable]
		public CorpseSkinShorts() : base( 0x1C00 )
		{
			Weight = 3.0;
			Hue = 2101;
		...
		public CorpseSkinShorts( Serial serial ) : base( serial )
		{
		}
	...
	public class HellishShorts : BaseArmor
	{
		...
		[Constructable]
		public HellishShorts() : base( 0x1C00 )
		{
			Weight = 3.0;
			Hue = 1645;
			ProtectionLevel = ArmorProtectionLevel.Guarding;
		...
		public HellishShorts( Serial serial ) : base( serial )
		{
		}
