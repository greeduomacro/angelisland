...
namespace Server.Items
{
	...
	public class CorpseSkinSkirt : BaseArmor
	{
		...
		[Constructable]
		public CorpseSkinSkirt() : base( 0x1C08 )
		{
			Weight = 1.0;
			Hue = 2101;
		...
		public CorpseSkinSkirt( Serial serial ) : base( serial )
		{
		}
	...
	public class HellishSkirt : BaseArmor
	{
		...
		[Constructable]
		public HellishSkirt() : base( 0x1C08 )
		{
			Weight = 1.0;
			Hue = 1645;
			ProtectionLevel = ArmorProtectionLevel.Guarding;
		...
		public HellishSkirt( Serial serial ) : base( serial )
		{
		}
