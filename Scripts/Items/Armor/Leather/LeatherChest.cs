...
namespace Server.Items
{
	...
	public class CorpseSkinTunic : BaseArmor
	{
		...
		[Constructable]
		public CorpseSkinTunic() : base( 0x13CC )
		{
			Weight = 6.0;
			Hue = 2101;
		...
		public CorpseSkinTunic( Serial serial ) : base( serial )
		{
		}
	...
	public class HellishTunic : BaseArmor
	{
		...
		[Constructable]
		public HellishTunic() : base( 0x13CC )
		{
			Weight = 6.0;
			Hue = 1645;
			ProtectionLevel = ArmorProtectionLevel.Guarding;
		...
		public HellishTunic( Serial serial ) : base( serial )
		{
		}
