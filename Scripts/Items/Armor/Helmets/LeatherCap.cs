...
namespace Server.Items
{
	...
	public class CorpseSkinHelm : BaseArmor
	{
		...
		[Constructable]
		public CorpseSkinHelm() : base( 0x1DB9 )
		{
			Weight = 2.0;
			Hue = 2101;
		...
		public CorpseSkinHelm( Serial serial ) : base( serial )
		{
		}
	...
	public class HellishHelmet : BaseArmor
	{
		...
		[Constructable]
		public HellishHelmet() : base( 0x1DB9 )
		{
			Weight = 2.0;
			Hue = 1645;
			ProtectionLevel = ArmorProtectionLevel.Guarding;
		...
		public HellishHelmet( Serial serial ) : base( serial )
		{
		}
