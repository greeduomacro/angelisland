...
namespace Server.Items
{
		...
		public class ArcticStormHelm : BaseArmor
	{
		...
		[Constructable]
		public ArcticStormHelm() : base( 0x1412 )
		{
			Weight = 5.0;
			Hue = 1364;
		...
		public ArcticStormHelm( Serial serial ) : base( serial )
		{
		}
    ...
    public class DreadSteelHelm : BaseArmor
	{
		...
		[Constructable]
		public DreadSteelHelm() : base( 0x1412 )
		{
			Weight = 5.0;
			Hue = 1236;
			ProtectionLevel = ArmorProtectionLevel.Guarding;
		...
		public DreadSteelHelm( Serial serial ) : base( serial )
		{
		}
