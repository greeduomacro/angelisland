...
namespace Server.Items
{
    ...
    public class ArcticStormArms : BaseArmor
	{
		...
		[Constructable]
		public ArcticStormArms() : base( 0x1410 )
		{
			Weight = 5.0;
			Hue = 1364;
		...
		public ArcticStormArms( Serial serial ) : base( serial )
		{
		}
    ...
    public class DreadSteelArms : BaseArmor
	{
		...
		[Constructable]
		public DreadSteelArms() : base( 0x1410 )
		{
			Weight = 5.0;
			Hue = 1236;
			ProtectionLevel = ArmorProtectionLevel.Guarding;
		...
		public DreadSteelArms( Serial serial ) : base( serial )
		{
		}
