...
namespace Server.Items
{
	...
	public class UnholyBoneGloves : BaseArmor
	{
		...
		[Constructable]
		public UnholyBoneGloves() : base( 0x1450 )
		{
			Weight = 2.0;
			Hue = 1109;
		...
		public UnholyBoneGloves( Serial serial ) : base( serial )
		{
		}
    ...
    public class BoneMagiGloves : BaseArmor
    {
        ...
        [Constructable]
        public BoneMagiGloves() : base( 0x1450 )
        {
            Weight = 2.0;
            Quality = ArmorQuality.Exceptional;
        ...
        public BoneMagiGloves(Serial serial) : base( serial )
        {
        }
