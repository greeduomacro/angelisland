...
namespace Server.Items
{
	public class CommunicationCrystal : Item, ISecurable
	{
		...
		[Constructable]
		public CommunicationCrystal() : this( DefaultMultiplier )
		{
		}

		[Constructable]
		public CommunicationCrystal( double mult ) : base( 0x1ECD )
		{
...
//				comm.Connected.Remove( this );
		...
		public CommunicationCrystal( Serial serial ) : base( serial )
		{
		}
