...
namespace Server.Items
{
	public class PortcullisNS : BaseDoor
	{
		...
		[Constructable]
		public PortcullisNS() : base( 0, 0, 0x6F5, 0x6F5, 0xF0, 0xEF, DoorFacing.EastCCW, new Point3D( 0, 0, 20 ) )
		{
		}
	...
	public class PortcullisEW : BaseDoor
	{
		...
		[Constructable]
		public PortcullisEW() : base( 0, 0, 0x6F6, 0x6F6, 0xF0, 0xEF, DoorFacing.EastCCW, new Point3D( 0, 0, 20 ) )
		{
		}
