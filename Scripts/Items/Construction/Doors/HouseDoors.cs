...
namespace Server.Items
{
	...
	{
		[Constructable]
		public MetalHouseDoor( DoorFacing facing ) : base( 0x675, 0x676, -1, -1, 0xEC, 0xF3, facing, Point3D.Zero )
		{
		}
	...
	{
		[Constructable]
		public DarkWoodHouseDoor( DoorFacing facing ) : base( 0x6A5, 0x6A6, -1, -1, 0xEA, 0xF1, facing, Point3D.Zero )
		{
		}
	...
	{
		[Constructable]
		public GenericHouseDoor( DoorFacing facing, int baseItemID, int openedSound, int closedSound ) : base( baseItemID, baseItemID + 1, -1, -1, openedSound, closedSound, facing, Point3D.Zero )
		{
		}
