...
namespace Server.Items
{
	...
	{
		[Constructable]
		public HolidayDeed() : base( 0x14F0 )
		{
		...
		public HolidayDeed( Serial serial ) : base( serial )
		{
		}
	...
	public class HalloweenDeed : Item 
	{
		...
		[Constructable]
		public HalloweenDeed() : this (0)
		{
			
		}

		[Constructable]
		public HalloweenDeed(int place) : base( 0x14F0 )
		{
			Weight = 1.0;
			Hue = 44;
			LootType = LootType.Newbied;
		...
		public HalloweenDeed( Serial serial ) : base( serial )
		{
		}
