...
namespace Server.Items
{
	...
	public class CertificateOfIdentity : Item // Create the item class which is derived from the base item class
	{
		...
		[Constructable]
		public CertificateOfIdentity() : base( 0x14F0 )
		{
			Weight = 1.0;
		...
		public CertificateOfIdentity( Serial serial ) : base( serial )
		{
		}
		...
		public bool Used
		{
			get { return (m_flags & Flags.Used) > 0; }
			set { if (value == true) m_flags |= Flags.Used; else m_flags &= ~Flags.Used; }
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			if (m_Mobile == null && (m_flags & Flags.Used) > 0)
			{
