...
# In the teleporter props, map destination needs to be set to Felucca, and 
    ...
    public class TeleporterPairAddon : BaseAddon
	{
		...
		public TeleporterPairAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class TeleporterAddonDeed : BaseAddonDeed
	{
		...
		public TeleporterAddonDeed( Serial serial ) : base( serial )
		{
		}
		...
		private class FirstTarget : Target
		{
			...
			public FirstTarget( TeleporterAddonDeed deed ) : base( -1, true, TargetFlags.None )
			{
				m_Deed = deed;
				this.CheckLOS = false;
			}
		...
		private class SecondTarget : Target
		{
			...
			public SecondTarget( TeleporterAddonDeed deed ) : base( -1, true, TargetFlags.None )
			{
				m_Deed = deed;
				this.CheckLOS = false;
			}
	...
	public class TeleporterAC : AddonComponent
	{
		...
		public TeleporterAC( IPoint3D location, Map map ) : this()
		{
			m_PointDest = new Point3D(location);
			m_MapDest = map;
		}

		public TeleporterAC( Serial serial ) : base( serial )
		{
		}
