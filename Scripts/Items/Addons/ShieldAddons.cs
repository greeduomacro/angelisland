...
namespace Server.Items
{
	...
	#region silver sepent shield
		...
		public class SilverSerpentShieldEastAddon : BaseAddon
		{
			...
			public SilverSerpentShieldEastAddon(Serial serial) : base(serial)
			{
			}
		...
		{
			[Constructable]
			public SilverSerpentShieldEast() : this( 0x1577 )
			{
			}

			public SilverSerpentShieldEast( int itemID ) : base( itemID )
			{
			}
		...
		{
			[Constructable]
			public SilverSerpentShieldSouth() : this(0x1576)
			{
			}

			public SilverSerpentShieldSouth(int itemID) : base(itemID)
			{
			}

			public SilverSerpentShieldSouth(Serial serial) : base(serial)
			{
			}
