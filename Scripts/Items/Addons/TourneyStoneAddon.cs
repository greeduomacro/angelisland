...
namespace Server.Items
{
	...
	public class TourneyStoneAddon : BaseAddon
	{
		...
		public TourneyStoneAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class TourneyStoneAddonDeed : BaseAddonDeed
	{
		...
		public TourneyStoneAddonDeed( Serial serial ) : base( serial )
		{
		}
...
{
	[Constructable]
	public TourneyStoneBase() : this( 1306 )
	{
		Name = "a tourney stone";
		Hue = 937;
	}

	public TourneyStoneBase( int itemID ) : base( itemID )
	{
	}

	public TourneyStoneBase( Serial serial ) : base( serial )
	{
	}
...
{
	[Constructable]
	public TourneyStoneRune() : this( 3686 )
	{
		Name = "a tourney stone";
		Hue = 153;
	}

	public TourneyStoneRune( int itemID ) : base( itemID )
	{
	}

	public TourneyStoneRune( Serial serial ) : base( serial )
	{
	}
