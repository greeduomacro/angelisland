...
namespace Server.Items
{
	...
	public abstract class BaseHouseDoorComponent : BaseHouseDoor
	{
		...
		public BaseHouseDoorComponent( int closedID, int openedID, int customClosedID, int customOpenedID, int openedSound, int closedSound, DoorFacing facing, Point3D offset ) : base( closedID, openedID, customClosedID, customOpenedID, openedSound, closedSound, facing, offset )
		{
			Movable = false;
		}

		public BaseHouseDoorComponent(Serial s) : base(s)
		{
		}
	...
	public abstract class BaseHouseDoorAddon : BaseAddon
	{
        ...
        */
		...
		public BaseHouseDoorAddon() : base()
		{
		}

		public BaseHouseDoorAddon(Serial s) : base(s)
		{
		}
