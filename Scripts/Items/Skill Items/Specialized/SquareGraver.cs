...
namespace Server.Items
{
	...
	public class SquareGraverTarget : Target
	{
		...
		public SquareGraverTarget(SquareGraver graver) : base( 1, false, TargetFlags.None )
		{
			m_Graver = graver;
		}
	...
	public class SquareGraver : Item
	{
		...
		[Constructable]
		public SquareGraver() : base( 0x10E7 )
		{
			base.Weight = 1.0;
		...
		public SquareGraver( Serial serial ) : base( serial )
		{
		}
