...
namespace Server.Gumps
{
	public class PropertiesGump : Gump
	{
		...
		public PropertiesGump( Mobile mobile, object o, Stack stack, object parent ) : base( GumpOffsetX, GumpOffsetY )
		{
			m_Mobile = mobile;
			m_Object = o;
			m_Stack = stack;
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			if ( !Scripts.Commands.BaseCommand.IsAccessible( from, m_Object ) )
			{
