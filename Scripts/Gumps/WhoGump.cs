...
namespace Server.Gumps
{
	public class WhoGump : Gump
	{
		...
		public WhoGump( Mobile owner ) : this( owner, "" )
		{
		}

		public WhoGump( Mobile owner, string filter ) : this( owner, BuildList( owner, filter ), 0, filter )
		{
		}

		public WhoGump( Mobile owner, ArrayList list, int page, string filter ) : base( GumpOffsetX, GumpOffsetY )
		{
