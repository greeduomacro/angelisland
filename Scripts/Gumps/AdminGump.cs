...
//			};
		...
		public static string FormatAccessLevel( AccessLevel level )
		{
			switch(level)
			{
				//case AccessLevel.OldPlayer: return "OldPlayer";
				//case AccessLevel.OldCounselor: return "OldCounselor";
				//case AccessLevel.OldGameMaster: return "OldGameMaster";
				//case AccessLevel.OldSeer: return "OldSeer";
				//case AccessLevel.OldAdministrator: return "OldAdministrator";
		...
		public void AddAccountHeader()
		{
			...
			AddButtonLabeled( 200, 80, GetButtonID( 5, 32 ), "View All: Empty" );
			...
			switch ( type )
			{
				...
				case 5:
				{
					switch ( index )
					{
						...
						case 32: // View all empty accounts
						{
							ArrayList results = new ArrayList();
		...
		{
			Commands.Handle( m_From, String.Format( "{0}{1}", Server.Commands.CommandPrefix, ip ) );
		}
