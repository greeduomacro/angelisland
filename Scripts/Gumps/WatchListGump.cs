...
namespace Server.Gumps
{
	public class WatchListGump : Gump
	{
		...
		public WatchListGump( Mobile owner ) : this( owner, BuildList( owner ), 0 )
		{
		}

		public WatchListGump( Mobile owner, ArrayList list, int page ) : base( GumpOffsetX, GumpOffsetY )
		{
    ...
    public class WatchListChooserGump : Gump
    {
        ...
        {
            Commands.Register("Watch", AccessLevel.Counselor, new CommandEventHandler(Watch_OnCommand));
            Commands.Register("WatchList", AccessLevel.Counselor, new CommandEventHandler(WatchList_OnCommand));
			Commands.Register("Unwatch", AccessLevel.Counselor, new CommandEventHandler(Unwatch_OnCommand));
        }
        ...
        private class WatchTarget : Target
        {
            ...
            public WatchTarget(bool bWatch) : base(-1, false, TargetFlags.None)
            {
				m_bWatch = bWatch;
            }
