...
namespace Server.Items
{
	...
	public class SurveyToolCategoryGump : Gump
	{
		...
		public SurveyToolCategoryGump( Mobile from ) : base( 50, 50 )
		{
			m_From = from;
	...
	public class SurveyToolListGump : Gump
	{
		...
		public SurveyToolListGump( Mobile from, SurveyToolEntry[] entries ) : base( 50, 50 )
		{
			m_From = from;
			m_Entries = entries;
	...
	public class NewSurveyToolTarget : MultiTarget
	{
		...
		public NewSurveyToolTarget( SurveyToolEntry[] entries, SurveyToolEntry entry ) : base( entry.MultiID, entry.Offset )
		{
			Range = 14;
