...
namespace Server.Multis
{
	public class SmallOldHouse : BaseHouse
	{
		...
		public SmallOldHouse( Mobile owner, int id ) : base( id, owner, 270, 2, 2 )
		{
	...
	public class GuildHouse : BaseHouse
	{
		...
		public GuildHouse( Mobile owner ) : base( 0x74, owner, 600, 4, 2 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class TwoStoryHouse : BaseHouse
	{
		...
		public TwoStoryHouse( Mobile owner, int id ) : base( id, owner, 750, 5, 3 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class Tower : BaseHouse
	{
		...
		public Tower( Mobile owner ) : base( 0x7A, owner, 1150, 8, 4 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class Keep : BaseHouse//warning: ODD shape!
	{
		...
		public Keep( Mobile owner ) : base( 0x7C, owner, 1300, 9, 5 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class Castle : BaseHouse
	{
		...
		public Castle( Mobile owner ) : base( 0x7E, owner, 1950, 14, 7 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class LargePatioHouse : BaseHouse
	{
		...
		public LargePatioHouse( Mobile owner ) : base( 0x8C, owner, 600, 4, 2 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class LargeMarbleHouse : BaseHouse
	{
		...
		public LargeMarbleHouse( Mobile owner ) : base( 0x96, owner, 750, 5, 3 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class SmallTower : BaseHouse
	{
		...
		public SmallTower( Mobile owner ) : base( 0x98, owner, 300, 2, 2 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class LogCabin : BaseHouse
	{
		...
		public LogCabin( Mobile owner ) : base( 0x9A, owner, 600, 4, 2 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class SandStonePatio : BaseHouse
	{
		...
		public SandStonePatio( Mobile owner ) : base( 0x9C, owner, 450, 3, 2 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class TwoStoryVilla : BaseHouse
	{
		...
		public TwoStoryVilla( Mobile owner ) : base( 0x9E, owner, 600, 4, 2 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class SmallShop : BaseHouse
	{
		...
		public SmallShop( Mobile owner, int id ) : base( id, owner, 275, 2, 2 )
		{
			uint keyValue = CreateKeys( owner );
