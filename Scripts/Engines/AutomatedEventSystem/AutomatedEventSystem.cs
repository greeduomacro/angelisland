...
namespace Server
{
	...
	public class AutomatedEventSystem : Item
	{
		...
		[Constructable]
		public AutomatedEventSystem() : base( 0x1F14 )
		{
		...
		public AutomatedEventSystem(Serial serial) : base( serial )
		{
		}
		...
		public class ActionTimer : Timer
		{
			...
			public ActionTimer( AutomatedEventSystem ix, TimeSpan delay ) : base( TimeSpan.FromMinutes(0.5), delay )
			{
				m_AES = ix;
	...
	public class CrazyMapDayAES : AutomatedEventSystem
	{
		...
		public CrazyMapDayAES(Serial serial) : base( serial )
		{
		}
	...
	public class TownInvasionAES : AutomatedEventSystem
	{
		...
		public TownInvasionAES(Serial serial) : base( serial )
		{
		}
	...
	public class KinRansomAES : AutomatedEventSystem
	{
		...
		public KinRansomAES(Serial serial) : base( serial )
		{
		}
		...
		public override void OnEventStartInit()
		{
			...
			try
			{
				...
				{	
					...
					m_KinRansomChest.TrapPower = 100;
		...
		public void OnChestOpenInit()
		{
			...
			m_KinRansomChest.RequiredSkill = 100;
			...
			try
			{
				if (bInit)
				{
					...
					foreach (Item item in World.Items.Values)
					{
						...
						ArrayList creatures = spawner.Creatures;
	...
	public class ServerWarsAES : AutomatedEventSystem
	{
		...
		public ServerWarsAES(Serial serial) : base( serial )
		{
		}
