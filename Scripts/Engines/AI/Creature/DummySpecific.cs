...
namespace Server.Mobiles
{
	...
	public class DummyFence : Dummy
	{
		...
		[Constructable]
		public DummyFence() : base(AIType.AI_Melee, FightMode.All | FightMode.Closest, 15, 1, 0.2, 0.6)
		{
			// A Dummy Fencer
			int iHue = 20 + Team * 40;
			int jHue = 25 + Team * 40;
	...
	public class DummySword : Dummy
	{
		...
		[Constructable]
		public DummySword() : base(AIType.AI_Melee, FightMode.All | FightMode.Closest, 15, 1, 0.2, 0.6)
		{
			// A Dummy Swordsman
			int iHue = 20 + Team * 40;
			int jHue = 25 + Team * 40;
	...
	public class DummyNox : Dummy
	{
		...
		[Constructable]
		public DummyNox() : base(AIType.AI_Mage, FightMode.All | FightMode.Closest, 15, 1, 0.2, 0.6)
		{
	...
	public class DummyStun : Dummy
	{
		...
		[Constructable]
		public DummyStun() : base(AIType.AI_Mage, FightMode.All | FightMode.Closest, 15, 1, 0.2, 0.6)
		{
	...
	public class DummySuper : Dummy
	{
		...
		[Constructable]
		public DummySuper() : base(AIType.AI_Mage, FightMode.All | FightMode.Closest, 15, 1, 0.2, 0.6)
		{
			// A Dummy Super Mage
			int iHue = 20 + Team * 40;
			int jHue = 25 + Team * 40;
	...
	public class DummyHealer : Dummy
	{
		...
		[Constructable]
		public DummyHealer() : base(AIType.AI_Healer, FightMode.All | FightMode.Closest, 15, 1, 0.2, 0.6)
		{
			// A Dummy Healer Mage
			int iHue = 20 + Team * 40;
			int jHue = 25 + Team * 40;
