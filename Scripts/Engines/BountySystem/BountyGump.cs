...
*/
		...
		private void BuildGump()
		{
			...
			string outputstring = "Would you like to place a bounty on " + m_Killer.Name + "?";
			AddHtml( 80, 50, 330, 80, outputstring, false, false );
			
			AddHtml( 125, 90, 180, 180, "Amount:", false, false );
			AddImageTiled( 174, 89, 106, 21, PropsConfig.HeaderGumpID );
			AddTextEntry( 175, 90, 105, 20, 0xFA5, 0, "0" );
						
			AddButton( 40, 125, 0xFA5, 0xFA7, 1, GumpButtonType.Reply, 0 );
			AddHtmlLocalized( 75, 130, 90, 80, 1046362, false, false ); // Yes


			AddButton( 320, 125, 0xFA5, 0xFA7, 2, GumpButtonType.Reply, 0 );
			AddHtmlLocalized( 355, 130, 90, 80, 1046363, false, false ); // No
		}
