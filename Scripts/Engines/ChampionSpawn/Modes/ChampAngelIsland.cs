...
{	
	public class ChampAngelIsland : ChampEngine
	{
		...
		public ChampAngelIsland( Serial serial ) : base( serial )
		{
		}
		...
		private class DeletionTimera : Timer
		{
			...
			public DeletionTimera( Item tele, Item sparkles, TimeSpan delayspan ) : base( delayspan )
			{
				m_Telea = tele;
				m_Shineya = sparkles;
		...
		{
			public PrettyShiney() : base( 0x375A )
			{
			}
			public PrettyShiney( Serial serial ) : base( serial )
			{
			}
			public override void Serialize( GenericWriter writer )
			{
		...
		private class DeletionTimerb : Timer
		{
			...
			public DeletionTimerb( Item tele, Item sparkles, TimeSpan delayspan ) : base( delayspan )
			{
				m_Teleb = tele;
				m_Shineyb = sparkles;
				Priority = TimerPriority.TwentyFiveMS;
