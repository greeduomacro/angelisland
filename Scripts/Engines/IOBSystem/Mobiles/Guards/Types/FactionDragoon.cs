...
/* Scripts\Engines\IOBSystem\Mobiles\Guards\Types\FactionDragoon.cs
 * ChangeLog
 *	01/14/09, plasma
...
namespace Server.Engines.IOBSystem
{
	...
	public class FactionDragoon : BaseFactionGuard
	{
		...
		{
			BardImmune = true;
			FightStyle = FightStyle.Magic | FightStyle.Melee | FightStyle.Smart | FightStyle.Bless | FightStyle.Curse;
