 ...
 *
 ***************************************************************************/
// 04,arpil,2004 edited gumps and uploaded gump changed for carp/woodworking lines 70-76 gump changes /07,april,2004 edited lines 70-76 again to refix the gumps i screwed up in the first place :)
using System;
...
namespace Server.Engines.Craft
{
	public class CraftGump : Gump
	{
		...
		private CraftGump( Mobile from, CraftSystem craftSystem, BaseTool tool, object notice, CraftPage page ) : base( 30, 30 ) // eddited by sam for woodworking changes
		{
			m_From = from;
