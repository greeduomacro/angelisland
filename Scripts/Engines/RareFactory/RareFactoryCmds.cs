...
namespace Server.Scripts.Commands
{
	...
	public class RareFactoryCmds
	{
		...
		{
			Server.Commands.Register("RareFactory", AccessLevel.Administrator, new CommandEventHandler(RareFactory_OnCommand));
			Server.Commands.Register("AcquireRare", AccessLevel.Administrator, new CommandEventHandler(AcquireRare_OnCommand));
			Server.Commands.Register("PatchDODInst", AccessLevel.Administrator, new CommandEventHandler(PatchDODInst_OnCommand));
			Server.Commands.Register("DumpRares", AccessLevel.Administrator, new CommandEventHandler(DumpRares_OnCommand));
            Server.Scripts.Commands.TargetCommands.Register(new AddRareCommand());
		}
