	...
	public class MyRunUO : Timer
	{
		...
		public static void Initialize()
		{
			if ( Config.Enabled )
			{
				...
				Commands.Register( "UpdateMyRunUO", AccessLevel.Administrator, new CommandEventHandler( UpdateMyRunUO_OnCommand ) );

				Commands.Register( "PublicChar", AccessLevel.Player, new CommandEventHandler( PublicChar_OnCommand ) );
				Commands.Register( "PrivateChar", AccessLevel.Player, new CommandEventHandler( PrivateChar_OnCommand ) );
			}
		}
...
/*					commented out because we're using transactions, and TRUNCATE 
 * dont play nice
